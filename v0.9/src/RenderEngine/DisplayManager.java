...
public class DisplayManager {
	...
	private static final int FPS_CAP = 256;
	...
	public static void createDisplay() {
		...
		try {
			...
			Display.create(new PixelFormat().withDepthBits(24), attribs); // put 8,8,0,8 in new PixelFOrmat for basic
																			// anti-aliasing
			Display.setTitle("GaryTheBlobfish::VoxelEngine v0.9");
...
//				
	...
	public static void closeDisplay() {
		...
		System.out.println("Average FPS this game session: " + totalFPS / FPScount);
