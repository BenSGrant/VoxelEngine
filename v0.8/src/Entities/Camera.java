...
public class Camera {
	...
	public void move(float delt/*ChunkMesh currentChunk*/) {
		//for (int b = 0; b < currentChunk.chunk.getBlockCount(); b++) {
			//Vector3f blockPos = new Vector3f(currentChunk.chunk.blocks.get(b).x, currentChunk.chunk.blocks.get(b).y, currentChunk.chunk.blocks.get(b).z);
