...
public class MainGameLoop {
	...
	public static void main(String[] args) {
		...
		writeToFile("Created ModelTexture using asset res/textures/grid.PNG ...");
		...
		*/
		...
		while (!Display.isCloseRequested()) {
			cam.move();
			System.out.println("POSITION:    X: " + cam.getPosition().x * TerrainGenerator.chunkSize + "    Y: " + cam.getPosition().y + "    Z: " + cam.getPosition().x * TerrainGenerator.chunkSize);
